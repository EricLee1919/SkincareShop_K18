        ...
        <Grid item xs={12}>
          <Paper elevation={3} sx={{ p: 4 }}>
            ...
            <Box sx={{ mt: 4 }}>
              ...
              <Typography variant="body1" paragraph>
                Our mission is to empower individuals to achieve their skincare
                goals by offering carefully curated products from trusted
                brands. We believe that everyone deserves access to effective
                skincare solutions that work.
              </Typography>
