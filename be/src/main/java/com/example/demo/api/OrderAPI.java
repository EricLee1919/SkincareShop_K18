...
public class OrderAPI {
    ...
    @PatchMapping("/rating/{orderDetailId}")
    public ResponseEntity rating(@PathVariable long orderDetailId, @RequestBody RatingRequest ratingRequest){
        OrderDetail orderDetail = orderService.rating(orderDetailId, ratingRequest);
